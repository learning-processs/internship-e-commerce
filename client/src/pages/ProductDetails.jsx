...
const DETAILED_PRODUCTS = [
  { id: 1, title: 'Wireless Headphones', price: 99, category: 'Electronics', rating: 4.5, reviews: 128, description: 'Experience pure audio bliss with premium active noise-canceling technology, plush ergonomic memory foam ear cups, and an ultra-extended 40-hour battery life package perfect for travel.', img: 'https://brain-images-ssl.cdn.dixons.com/8/2/10207228/u_10207228.jpg' },
  { id: 2, title: 'Smart Watch', price: 149, category: 'Electronics', rating: 4.2, reviews: 95, description: 'Track workouts, optimize your sleep patterns, monitor heart rate metrics, and view real-time smart notification alerts directly on a striking, crisp always-on high-definition AMOLED touchscreen layout.', img: 'https://static1.anpoimages.com/wordpress/wp-content/uploads/2024/06/015-galaxy-watch-fe-silver-r-perspective-1.jpg' },
  { id: 3, title: 'Leather Backpack', price: 79, category: 'Fashion', rating: 4.8, reviews: 210, description: 'Handcrafted utilizing premium full-grain weather-resistant genuine leather accents. Features dedicated padded compartments for 15-inch laptops alongside hidden quick-access anti-theft organizer pockets.', img: 'https://therealleathercompany.com/cdn/shop/files/the-standard-leather-laptop-backpack-for-men_9.jpg?v=1740411587' },
  { id: 4, title: 'Running Shoes', price: 120, category: 'Fashion', rating: 4.4, reviews: 84, description: 'Engineered featuring proprietary responsive cushion technology midsoles paired with breathable knit uppers designed to dramatically elevate athletic output over long distance run milestones.', img: 'https://sc01.alicdn.com/kf/HTB1REpsXIfrK1Rjy1Xdq6yemFXa8/New-arrival-cheap-name-brand-kids-sport.jpg' },
  { id: 5, title: 'Mechanical Keyboard', price: 89, category: 'Electronics', rating: 4.7, reviews: 156, description: 'Elevate desktop speed typing and competitive gaming using responsive, clicky hot-swappable tactile mechanical custom key switches framed beneath bright premium customizable dynamic layout RGB profiles.', img: 'https://m.media-amazon.com/images/I/61nghmq8GPL._AC_.jpg' },
  { id: 6, title: 'Ceramic Coffee Mug', price: 25, category: 'Home Decor', rating: 4.9, reviews: 320, description: 'Artisanal kiln-fired heavy durable ceramic craft designed with elegant textured minimalist aesthetics coupled with optimal insulation structural walls keeping beverages hot for hours.', img: 'https://i5.walmartimages.com/seo/24-oz-Large-Ceramic-Coffee-mugs-Extra-Large-Tea-Coffee-Cups-Large-Handle-Coffee-Mug-Office-Home-Microwave-Diahwasher-Safe-24-oz-green_4ece6abb-82fa-41eb-aefd-876add9a905a.26d4fa5fbaf53eda7a9e26d6ebc3faab.jpeg' },
];
